...
// Trigger for "slack"
ipc.on('slack', function () {
	document.querySelector('a[ng-href="#slack"], a[href="#slack"]').click();

});

// Trigger for "active collab"
ipc.on('active', function () {
	document.querySelector('a[ng-href="#active"], a[href="#active"]').click();
